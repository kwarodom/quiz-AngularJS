(function(){
    ...
    app.controller('QuizController',['$scope', '$http', '$sce', function ($scope,$http,$sce){
        ...
        $scope.selectAnswer = function (qIndex, aIndex) {
            // alert('qIndex' + qIndex + 'aIndex' + aIndex); //for testing
        ...
        $scope.createShareLink = function (percentage) {
            ...
            var facebookLink = '<a class="btn facebook" target="_blank" href="http://www.facebook.com/dialog/feed?app_id=599703650211336&link=http://developers.facebook.com/docs/reference/dialogs/' +
                '&picture=http://fbrell.com/f8.jpg' +
                '&name=Saturn%20Quiz!' +
                '&caption=This%20is%20so%20cool%20man!' +
                '&description=I scored a '+percentage+'% on this quiz about Saturn. Try to beat my score at '+url+'' +
                '&message=Facebook%20Dialogs%20are%20so%20easy! test dsadas d dsadsdsaad">Share your score</a>';
